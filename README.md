...
**[Portfolio]** This React project is about building a personal portfolio to track and display my progresses and achievements all allong my Software developer career.
...
- [x] Added all necessary fetures for displaying Projects and achievements.
...
```sh
  git https://github.com/adeola003/portfolio-react.git
  cd portfolio-react
```
...
- [x] Add new projects and new interesting sections
- [x] Add recorded presentations for my most complex projects
...
Feel free to check the [issue page](https://github.com/adeola003/portfolio-react/issues).
...
- Thanks for all my partners that accompanied me during this journey.
